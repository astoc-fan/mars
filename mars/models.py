...
class inv_register(db.Model):
    ...
    usagedistinction = db.Column(db.String(256))
    ei_invoice_ref = db.Column(db.String(10))
    file = db.Column(db.String(10))
    tc = db.Column(db.String(256))
    canceling_inv_reference = db.Column(db.String(256))
    issue_date = db.Column(db.DateTime)
    issue_date_month = db.Column(db.String(2))
    issue_date_year = db.Column(db.String(5))
    amount = db.Column(db.String(20))
    currency = db.Column(db.String(10))
    foreign_amount = db.Column(db.String(20))
    foreign_currency = db.Column(db.String(10))
    vat_amount = db.Column(db.String(20))
    tax_invoice_status = db.Column(db.String(256))
    internal_tax_ref = db.Column(db.String(256))
    vat_invoice_ref = db.Column(db.String(256))
    vat_issue_date = db.Column(db.String(256))
    vat_issue_date_month = db.Column(db.String(256))
    vat_issue_date_year = db.Column(db.String(256))
    first_vat_inv_ref = db.Column(db.String(256))
    first_vat_issue_date = db.Column(db.String(256))
    first_vat_issue_date_month = db.Column(db.String(256))
    first_vat_issue_date_year = db.Column(db.String(256))
    consol = db.Column(db.String(256))
    service_order = db.Column(db.String(256))
    mbl = db.Column(db.String(256))
    hbl = db.Column(db.String(256))
